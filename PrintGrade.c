...
void main()
{
  char Name[30][40] = {"Angkana Sinreungsang", "Nuchakorn Benjanukorn", "Ying Phakpon","Chai Chanchai", "Yong Boonsith", "Kitti Karndee"};
  int ID[30] = {5301, 5302, 5303, 5304, 5305, 5306};
  float GPA[30] = {3.62, 2.50, 3.65, 3.24, 1.32, 3.26}; 
  int N = 6, i;
